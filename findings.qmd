...
The outermost western, eastern and southern regions are still colored light blue, indicating no improvement in accessibility to primary schools. Areas with school closures and mergers (as shown in the map for before primary school mergers, where the pink symbols are) are not visibly affected as there are still existing primary schools in the near vicinity. 
